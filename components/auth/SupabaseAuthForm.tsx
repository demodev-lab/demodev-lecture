...
export default function SupabaseAuthForm({ mode, onModeChange, onSuccess }: AuthFormProps) {
  const { signIn, signUp, signInWithOAuth } = useSupabaseAuth();
  ...
  const handleOAuthLogin = async (provider: string) => {
    ...
    } else if (provider === 'naver' || provider === 'apple') {
      console.log(`${provider} OAuth는 추가 설정이 필요합니다`);
    }
  };
