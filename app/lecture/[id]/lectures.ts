...
export const lectures: Lecture[] = [
  {
    ...
    description:
      "AI 도구를 활용해 개발 지식 없이도 3시간 만에 완성도 높은 웹사이트를 만드는 방법을 배웁니다.",
    detailedDescription: `
    ...
    chapters: [
      {
        ...
        description:
          "ChatGPT, Claude, Cursor 등 AI 도구 소개 및 개발 환경 설정",
        isFree: true,
      },
      {
        id: 2,
  ...
  },
  {
    ...
    description:
      "실무에서 바로 써먹을 수 있는 핵심적인 웹 개발 지식과 노하우를 배웁니다.",
    detailedDescription: `
  ...
  },
  {
    ...
    description:
      "Cursor AI를 활용해서 개발 지식 없이도 실제 서비스할 수 있는 AI 애플리케이션을 만들어봅니다.",
    detailedDescription: `
  ...
  },
  {
    ...
    description:
      "실제 앱스토어에 출시할 수 있는 수준의 모바일 앱을 처음부터 끝까지 완성하는 전 과정을 다룹니다.",
    detailedDescription: `
